...
class PointTester {
  public static void main(String[] args) {
    ...
    System.out.println("\tIt's being move -10 units on both the x and y axes");
    ...
    System.out.println("\tIt's being move -20 units on both the x, y and z axes");
    object1.translate(-20,-20, -20);
